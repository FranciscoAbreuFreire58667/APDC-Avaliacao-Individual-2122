...
//			}
			...
			if (role.equals(NEW_UserRole.GS.getRole()) && roleToBeRemoved.equals(NEW_UserRole.GS.getRole())) {
			...
			if (role.equals(NEW_UserRole.GS.getRole()) && roleToBeRemoved.equals(NEW_UserRole.SU.getRole())) {
				txt.rollback();
				LOG.warning("Username: " + username + " does not permission to complete this action.");
				return Response.status(Status.BAD_REQUEST).entity("no permission.").build();
			...
			if (role.equals(NEW_UserRole.GBO.getRole()) && !roleToBeRemoved.equals(NEW_UserRole.USER.getRole())) {
				txt.rollback();
				LOG.warning("Username: " + username + " does not permission to complete this action.");
				return Response.status(Status.BAD_REQUEST).entity("no permission.").build();
			}
